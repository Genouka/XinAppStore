...
local CACHE_APPLIST="xin_cache_applist"
local CACHE_BANNER="xin_cache_banner"
local CACHE_CATEGORY="xin_cache_category"
local CACHE_CONFIG_TIME="xin_cache_config"
--[[
