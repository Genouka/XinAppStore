...
function edang.applist(callback)
  edang_inner.pb_apidata(callback,CACHE_APPLIST,"https://wannianqingshi.github.io/WatchAppStore/server/app-list.json",
  function(info,data)
    --print(data)
...
function edang.bannar(callback)
  edang_inner.pb_apidata(callback,CACHE_BANNER,"https://wannianqingshi.github.io/WatchAppStore/server/lbt.json",
  function(info,data)
